# SC-shapes-the-maturation-of-cortical-morphology
   ...
   For the GAM and longitudinal analyses (items 8-9), we provide folowing data in the CBDP dataset at the highest resolution (1000 nodes).
   ...
   For the gene analysis (items 10-12), we provide folowing data.
